...
public class PresentationMode extends ActionBarActivity {
    ...
    //Holding user settings from connection settings activity
    private final String DEFAULTLINK=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        present.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String messageHold = settings.getString("myLink",DEFAULTLINK );
                messageHold.toString();
                message=messageHold;
               if(message!=null){
                   message="13"+message;
               ...
               else{Toast.makeText(getApplicationContext(),"Link is null",Toast.LENGTH_LONG).show();}
            }
        });
    }
    ...
    protected void onStart() {
        ...
        if(ipAddressServer.equals(DEFAULTIP) || portNumberServer == DEFAULTPORT){
            ...
            Toast.makeText(this,"No Valid Connection Was Found",Toast.LENGTH_LONG).show();
        }
        else{
